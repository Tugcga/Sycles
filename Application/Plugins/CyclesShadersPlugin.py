...
def CyclesShadersPlugin_CyclesMapping_1_0_Define(in_ctxt):
    ...
    add_input_float(no_port_pram_options(), params, 0, "RotationX", 0, 6.28)
    add_input_float(no_port_pram_options(), params, 0, "RotationY", 0, 6.28)
    add_input_float(no_port_pram_options(), params, 0, "RotationZ", 0, 6.28)
