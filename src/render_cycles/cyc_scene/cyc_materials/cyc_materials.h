...
ccl::ShaderNode* xsi_node_to_cycles(const XSI::Shader& xsi_shader, ccl::ShaderGraph* shader_graph, std::unordered_map<ULONG, ccl::ShaderNode*>& nodes_map, const XSI::CTime& eval_time);
